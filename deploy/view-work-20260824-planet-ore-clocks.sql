-- Deploy structs-pg:view-work-20260824-planet-ore-clocks to pg
--
-- structsd v0.21.0 moved shared ore mine/refine clocks from per-struct
-- attributes (3-/4-) to per-planet attributes (12-/13-). view.work MINE and
-- REFINE must read the planet clock via struct.location_id.
