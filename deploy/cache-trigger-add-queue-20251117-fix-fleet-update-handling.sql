-- Deploy structs-pg:cache-trigger-add-queue-20251117-fix-fleet-update-handling to pg
...
BEGIN;
    ...
    -- Clean up previous misses
    UPDATE structs.fleet
        SET command_struct = (
            SELECT value::jsonb->>'commandStruct'
            FROM cache.attributes
            WHERE key = 'fleet' AND value::jsonb->>'id' = fleet.id
