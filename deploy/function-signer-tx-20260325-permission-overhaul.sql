-- Deploy structs-pg:function-signer-tx-20260325-permission-overhaul to pg
--
-- Updates all signer.tx_ functions for the 24-bit permission system (110b).
...
--   PermHashRefine=4194304, PermHashRaid=8388608, PermAll=16777215

BEGIN;

    -- =========================================================================
    -- Provider functions (from function-signer-tx-energy.sql)
    -- =========================================================================
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_substation_id,262144,'structs','provider-create',jsonb_build_array(_substation_id, _rate_amount || _rate_denom, _access_policy, _provider_penalty, _consumer_penalty, _capacity_min, _capacity_max, _duration_min, _duration_max),'{}');
    END
    $BODY$
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_provider_id,131072,'structs','provider-withdraw-balance',jsonb_build_array(_provider_id, _destination_address),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_provider_id,4,'structs','provider-update-capacity-minimum',jsonb_build_array(_provider_id, _new_minimum_capacity),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_provider_id,4,'structs','provider-update-capacity-maximum',jsonb_build_array(_provider_id, _new_maximum_capacity),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_provider_id,4,'structs','provider-update-duration-minimum',jsonb_build_array( _provider_id, _new_minimum_duration),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_provider_id,4,'structs','provider-update-duration-maximum',jsonb_build_array( _provider_id, _new_maximum_duration),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_provider_id,4,'structs','provider-update-access-policy',jsonb_build_array( _provider_id, _access_policy),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_provider_id,8,'structs','provider-delete',jsonb_build_array( _provider_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;

    -- Drop removed provider guild functions
    DROP FUNCTION IF EXISTS signer.tx_provider_guild_grant(CHARACTER VARYING, CHARACTER VARYING, CHARACTER VARYING[]);
    DROP FUNCTION IF EXISTS signer.tx_provider_guild_revoke(CHARACTER VARYING, CHARACTER VARYING, CHARACTER VARYING[]);
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_provider_id,262144,'structs','agreement-open',jsonb_build_array(_provider_id, _duration, _capacity),'{}');
    END
    $BODY$
    LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_agreement_id,4,'structs','agreement-close',jsonb_build_array( _agreement_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_agreement_id,4,'structs','agreement-capacity-increase',jsonb_build_array( _agreement_id, _capacity_increase),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_agreement_id,4,'structs','agreement-capacity-decrease',jsonb_build_array( _agreement_id, _capacity_decrease),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_agreement_id,4,'structs','agreement-duration-increase',jsonb_build_array( _agreement_id, _duration_increase),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,2048,'structs','substation-allocation-connect',jsonb_build_array(_allocation_id, _substation_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,2048,'structs','substation-allocation-disconnect',jsonb_build_array(_allocation_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,4,'structs','allocation-transfer',jsonb_build_array(_allocation_id, _controller),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    BEGIN
        ...
        PERFORM signer.CREATE_TRANSACTION(_source_id,256,'structs','allocation-create',jsonb_build_array(_source_id, _amount),_flags);
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,4,'structs','allocation-update',jsonb_build_array(_allocation_id, _power),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,256,'structs','substation-create',jsonb_build_array(_allocation_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_substation_id,1024,'structs','substation-player-connect',jsonb_build_array(_substation_id, _target_player_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_substation_id,1024,'structs','substation-player-disconnect',jsonb_build_array(_target_player_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_substation_id,8,'structs','substation-delete',jsonb_build_array( _substation_id, _migration_substation_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_substation_id,1024,'structs','substation-player-migrate',jsonb_build_array( _substation_id, _target_player_ids),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;

    -- =========================================================================
    -- Infuse / Defuse / Migration functions
    -- =========================================================================
    ...
    BEGIN
        ...
        IF _real_destination ILIKE 'structsvaloper%' THEN
            PERFORM signer.CREATE_TRANSACTION(_player_id,32,'structs','reactor-infuse',jsonb_build_array(_delegator_address, _real_destination, _real_amount || _real_denom),'{}');
        ELSIF _real_destination ILIKE '5-%' THEN
            PERFORM signer.CREATE_TRANSACTION(_player_id,32,'structs','struct-generator-infuse',jsonb_build_array(_real_destination, _real_amount || _real_denom),'{}');
        END IF;
    ...
    BEGIN
        ...
        ELSE
            ...
            _real_amount := _amount * 10^6;
        END IF;
        PERFORM signer.CREATE_TRANSACTION(_player_id,64,'structs','reactor-begin-migration',jsonb_build_array( _delegator_address, _validator_src_address, _validator_dst_address, _real_amount || _real_denom),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    BEGIN
        ...
        ELSE
            ...
            _real_amount := _amount * 10^6;
        END IF;
        PERFORM signer.CREATE_TRANSACTION(_player_id,128,'structs','reactor-defuse',jsonb_build_array( _delegator_address, _validator_address, _real_amount || _real_denom),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    BEGIN
        ...
        ELSE
            ...
            _real_amount := _amount * 10^6;
        END IF;
        PERFORM signer.CREATE_TRANSACTION(_player_id,128,'structs','reactor-cancel-defusion',jsonb_build_array( _delegator_address, _validator_address, _real_amount || _real_denom, _creation_height),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;

    -- =========================================================================
    -- Guild functions (from function-signer-tx-guild.sql)
    -- =========================================================================

    CREATE OR REPLACE FUNCTION signer.tx_guild_create(
        _player_id CHARACTER VARYING,
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_reactor_id,524288,'structs','guild-create',jsonb_build_array(_reactor_id, _endpoint, _entry_substation_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_guild_id,65536,'structs','guild-update-entry-substation-id',jsonb_build_array( _guild_id, _entry_substation_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;

    CREATE OR REPLACE FUNCTION signer.tx_guild_update_entry_rank(
        _guild_id CHARACTER VARYING,
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_guild_id,512,'structs','guild-membership-invite',jsonb_build_array( _guild_id, _target_player_id, _substation_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_guild_id,512,'structs','guild-membership-invite-approve',jsonb_build_array( _guild_id, _target_player_id, _substation_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_guild_id,512,'structs','guild-membership-invite-deny',jsonb_build_array( _guild_id, _target_player_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_guild_id,512,'structs','guild-membership-invite-revoke',jsonb_build_array( _guild_id, _target_player_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,512,'structs','guild-membership-join',jsonb_build_array(_guild_id, _player_id, _substation_id, _infusion_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_guild_id,512,'structs','guild-membership-kick',jsonb_build_array( _guild_id, _target_player_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,512,'structs','guild-membership-request',jsonb_build_array( _guild_id, _player_id, _substation_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_guild_id,512,'structs','guild-membership-request-approve',jsonb_build_array( _guild_id, _target_player_id, _substation_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_guild_id,512,'structs','guild-membership-request-deny',jsonb_build_array( _guild_id, _target_player_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,512,'structs','guild-membership-request-revoke',jsonb_build_array( _guild_id, _target_player_id),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;

    -- =========================================================================
    -- Hash / PoW functions (from table-signer-tx-20251218-tx-function-permission-update.sql)
    -- =========================================================================
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,2097152,'structs','struct-ore-mine-complete',jsonb_build_array(_struct_id, _proof, _nonce ),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,4194304,'structs','struct-ore-refine-complete',jsonb_build_array(_struct_id, _proof, _nonce ),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,8388608,'structs','planet-raid-complete',jsonb_build_array(_fleet_id, _proof, _nonce ),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,1048576,'structs','struct-build-complete',jsonb_build_array(_struct_id, _proof, _nonce ),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;

    -- =========================================================================
    -- Player functions (from function-signer-tx-player.sql)
    -- =========================================================================
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,4,'structs','player-update-primary-address',jsonb_build_array(_primary_address),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,2,'structs','address-register',jsonb_build_array(_address_to_register, _proof_pub_key, _proof_signature, _permissions),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_player_id,2,'structs','address-revoke',jsonb_build_array(_address_to_revoke),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;

    -- =========================================================================
    -- New permission guild rank functions
    -- =========================================================================

    CREATE OR REPLACE FUNCTION signer.tx_permission_guild_rank_set(
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_object_id,2,'structs','permission-guild-rank-set',jsonb_build_array(_object_id, _guild_id, _permission, _rank),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;

    CREATE OR REPLACE FUNCTION signer.tx_permission_guild_rank_revoke(
        _object_id CHARACTER VARYING,
        _guild_id CHARACTER VARYING,
        _permission BIGINT
    ) RETURNS void AS
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(_object_id,2,'structs','permission-guild-rank-revoke',jsonb_build_array(_object_id, _guild_id, _permission),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;

    CREATE OR REPLACE FUNCTION signer.tx_player_update_guild_rank(
        _target_player_id CHARACTER VARYING,
        _guild_rank BIGINT
    ) RETURNS void AS
    $BODY$
    ...
    -- =========================================================================
    -- New player send function (structs module, separate from bank send)
    -- =========================================================================

    CREATE OR REPLACE FUNCTION signer.tx_player_send(
        _player_id CHARACTER VARYING,
        _from_address CHARACTER VARYING,
        _to_address CHARACTER VARYING,
        _amount NUMERIC,
        _denom CHARACTER VARYING
    ) RETURNS void AS
    $BODY$
    ...
    BEGIN
        ...
        PERFORM signer.CREATE_TRANSACTION(_player_id,16,'structs','player-send',jsonb_build_array(_from_address, _to_address, _real_amount || _real_denom),'{}');
    END
    $BODY$
        LANGUAGE plpgsql VOLATILE SECURITY DEFINER COST 100;

    -- =========================================================================
    -- Update CLAIM functions: HasOneOf -> HasAll permission check
    -- =========================================================================
            ...
            SELECT * FROM base_role
                ...
                WHERE
                  ...
                  AND  object_id IN (SELECT address_permission.object_id
                                          ...
                                          WHERE (address_permission.permission & tx.permission_requirement) = tx.permission_requirement)
    ...
    BEGIN
        ...
        WITH base_role AS (
                ...
                WHERE
                    ...
                    AND (permission & tx_permission_requirement) = tx_permission_requirement
    ...
    -- =========================================================================
    -- Update UPDATE_PENDING_ACCOUNT: PermAll 255 -> 16777215
    -- =========================================================================
    ...
    -- =========================================================================
    -- Update PLAYER_PENDING_JOIN_PROXY trigger: PermAssociations 16 -> PermGuildMembership 512
    -- =========================================================================
    ...
    $BODY$
    BEGIN
        PERFORM signer.CREATE_TRANSACTION(NEW.guild_id,512,'structs','guild-membership-join-proxy',jsonb_build_array(NEW.primary_address,NEW.pubkey,NEW.signature),'{}');
        RETURN NEW;
    END
    $BODY$
