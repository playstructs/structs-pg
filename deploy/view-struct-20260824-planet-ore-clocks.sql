-- Deploy structs-pg:view-struct-20260824-planet-ore-clocks to pg
--
-- structsd v0.21.0 moved ore mine/refine clocks to the planet. Recreate
-- view.struct (body from table-struct-type-20260612-add-armour-piercing)
-- so those two columns read planet attributes 12-/13- via struct.location_id.
-- Build clock (2-) stays on the struct.
