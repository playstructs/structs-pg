-- Deploy structs-pg:table-struct-type-20251120-fix-energy-precision to pg

BEGIN;

    ALTER TABLE structs.struct_type DROP COLUMN build_draw CASCADE;
    ALTER TABLE structs.struct_type DROP COLUMN passive_draw CASCADE;

    ALTER TABLE structs.struct_type ADD COLUMN build_draw NUMERIC GENERATED ALWAYS AS (structs.UNIT_LEGACY_FORMAT(build_draw_p, 'milliwatt')) STORED;
    ALTER TABLE structs.struct_type ADD COLUMN passive_draw NUMERIC GENERATED ALWAYS AS (structs.UNIT_LEGACY_FORMAT(passive_draw_p, 'milliwatt')) STORED;


    -- Rebuild the view. It hasn't changed
    ...
    SELECT
        ...
        struct_type.ore_mining_charge,
        struct_type.ore_refining_charge,
