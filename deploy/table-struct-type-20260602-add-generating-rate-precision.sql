-- Deploy structs-pg:table-struct-type-20260602-add-generating-rate-precision to pg

BEGIN;

    ALTER TABLE structs.struct_type RENAME COLUMN generating_rate TO generating_rate_p;

    ALTER TABLE structs.struct_type
        ADD COLUMN generating_rate NUMERIC
        GENERATED ALWAYS AS (generating_rate_p * 1000) STORED;
