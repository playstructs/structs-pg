-- Deploy structs-pg:table-struct-type-20251203-update-cheatsheet to pg

BEGIN;

    TRUNCATE TABLE structs.struct_type_cs;
    ...
    INSERT INTO structs.struct_type_cs VALUES('Jamming Satellite','EN','Applies Signal Jamming to all enemy Smart Weapon Attacks.','','','','','','','','','','','','Ore Surveillance','Automated surveillance technologies improve Planetary Defense.','Planetary Signal Jamming','Has a 1/3 chance to deflect all enemy Smart Weapon attacks.','','','','','','');
    ...
    INSERT INTO structs.struct_type_cs VALUES('Planetary Defense Cannon','EN','Launches Counter-Attacks against attacking Structs.','','','','','','','','','','','','Planetary Deterrent','Mass accelerators intimidate pirates.','Planetary Overwatch','Launches Counter-Attacks against attacking Structs.','','','','','','');
