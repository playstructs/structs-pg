-- Revert structs-pg:view-player-20260901-fix-total-load-capacity from pg
--
-- Restores the prior total_load / total_capacity formulas from
-- view-player-20260612-add-pfp-cr-attributes.
