-- Revert structs-pg:cache-trigger-add-queue-20260602-generating-rate-precision from pg
--
-- Restore handle_event_struct_type as it existed before generating_rate_p migration.
-- Reproduced verbatim from cache-trigger-add-queue-20260121-bigly-refactor.sql
