-- Revert structs-pg:trigger-player-pending-20260617-ugc-key-long-name from pg
--
-- Restores PLAYER_PENDING_JOIN_PROXY to the short ugc key
-- ('player-pfp-cr-attributes'), the body set by
