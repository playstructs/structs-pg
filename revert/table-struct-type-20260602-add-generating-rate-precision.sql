-- Revert structs-pg:table-struct-type-20260602-add-generating-rate-precision from pg

BEGIN;

    DROP VIEW IF EXISTS view.struct;

    ALTER TABLE structs.struct_type DROP COLUMN generating_rate;

    ALTER TABLE structs.struct_type RENAME COLUMN generating_rate_p TO generating_rate;
