-- Revert structs-pg:cache-trigger-add-queue-20260810-armour-piercing-default-false from pg
--
-- Restores cache.handle_event_struct_type to its prior body (raw armour-piercing
-- extraction without COALESCE), reproduced verbatim from
-- cache-trigger-add-queue-20260612-armour-piercing.sql.
