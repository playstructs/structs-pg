-- Revert structs-pg:table-struct-type-20260612-add-armour-piercing from pg
--
-- Drops view.struct, removes the two armour-piercing columns, and recreates
-- view.struct without them (body reproduced from
-- table-struct-type-20260602-add-generating-rate-precision.sql).
...
BEGIN;
    ...
    ALTER TABLE structs.struct_type
        DROP COLUMN IF EXISTS primary_weapon_armour_piercing,
        DROP COLUMN IF EXISTS secondary_weapon_armour_piercing;
