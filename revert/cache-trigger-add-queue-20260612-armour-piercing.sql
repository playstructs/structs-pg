-- Revert structs-pg:cache-trigger-add-queue-20260612-armour-piercing from pg
--
-- Restores cache.handle_event_struct_type to its prior body (no armour-piercing
-- fields), reproduced verbatim from
-- cache-trigger-add-queue-20260602-generating-rate-precision.sql.
