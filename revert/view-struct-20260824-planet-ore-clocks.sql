-- Revert structs-pg:view-struct-20260824-planet-ore-clocks from pg
--
-- Restore view.struct from table-struct-type-20260612-add-armour-piercing
-- (struct-scoped ore clocks).
